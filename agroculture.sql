...
(3, 'Kaivalya Hemant', 'Phenom', '$2y$10$22ezmzHRa9c5ycHmVm5RpOnlT4LwFaDZar1XhmLRJQKGrcVRhPgti', '61b4a64be663682e8cb037d9719ad8cd', 'kmendki98@gmail.com', '8600611198', 'abcde', 0);
...
(2, 'Pramod', 'Farmer', '$2y$10$22ezmzHRa9c5ycHmVm5RpOnlT4LwFaDZar1XhmLRJQKGrcVRhPgti', '61b4a64be663682e8cb037d9719ad8cd', 'pramod@gmail.com', '8618235317', 'xyz', 0, 0, 'png', 0),
(3, 'Kaivalya Hemant', 'ThePhenom', '$2y$10$22ezmzHRa9c5ycHmVm5RpOnlT4LwFaDZar1XhmLRJQKGrcVRhPgti', '61b4a64be663682e8cb037d9719ad8cd', 'Kaivalya@gmail.com', '8600611198', 'abcde', 0, 0, 'png', 0);
...
(3,24, 'Lemon', 'Vegetable', '<p>Citric Acid</p>\r\n', 50, 'Lemon5.jpg', 1),
(2,25,'Apple','Fruit','<p>Apple</p>\r\n',200,'Apple5.jpg',1),
(2,26,'Guava','Fruit','<p>Guava</p>\r\n',30,'Guava8.jpg',1),
(3, 28, 'Ladyfinger', 'Vegetable', '<p>Its veggie</p>\r\n', 1000, 'Ladyfinger5.jpg', 1),
(3, 29, 'Bajra', 'Grains', '<p>bajre di rti</p>\r\n', 400, 'Bajra4.jpg', 1),
(2, 30, 'Banana', 'Fruit', '<p>Jalgaon banana</p>\r\n', 400, 'Banana5.jpg', 1);
...
--
ALTER TABLE `buyer`
  ADD CONSTRAINT `buyer_ibfk_1` FOREIGN KEY (`bid`);
